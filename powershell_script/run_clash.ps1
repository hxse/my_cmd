...
Function e {
    # $clashPathDir = "D:\App\proxy\clash"
    # $clashPath = "D:\App\proxy\clash\clash-windows-386.exe"
    ...
    $clashPath = "D:\App\proxy\clash-meta\mihomo-windows-amd64-compatible-go120.exe"
